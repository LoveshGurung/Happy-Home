...
if (isset($_GET['gen_pdf']) && isset($_GET['id'])) {
    ...
    // Use 'Rs' explicitly instead of relying on currency symbols
    $table_data = "
    ...
    // Initialize Mpdf with a specific font
    $mpdf = new \Mpdf\Mpdf([
        'default_font' => 'Arial', // Use Arial to avoid special character rendering issues
    ]);
